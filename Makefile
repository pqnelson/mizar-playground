...
NOWEBOPTS=-filter ./localdef -latex
...
dumb_extract_text: defs
	noweave $(NOWEBOPTS) -n -index $(CHARACTERISTIC_SUBGROUP) > tex/characteristic.tex
	noweave $(NOWEBOPTS) -n -index $(RADICALS) > tex/radicals.tex
