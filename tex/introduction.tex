...
\subsection{Functor Definitions}\label{par:introduction:functor-one-g} What's going on here? Well, for any unital magma $G$, we have a
...
``\texttt{multMagma}'' satisfying the group properties (in Mizar, at least).
\end{remark}
