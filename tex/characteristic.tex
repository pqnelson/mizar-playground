...
\nwixlogsorted{c}{{Lemma: if $G$ is nontrivial and has a maximal subgroup, then $\forall\varphi\in\Aut(G)$, $\varphi(U(\Phi(G))) = U(\Phi(G))$}{NW47t2dy-2Z7ny9-1}{\nwixu{NW47t2dy-1wEepZ-1}\nwixd{NW47t2dy-2Z7ny9-1}}}%
...
\nwixlogsorted{c}{{Proof step: $\forall x$, $x\in\mathcal{F}\implies x\in\varphi(\mathcal{F})$}{NW47t2dy-49wKDh-1}{\nwixu{NW47t2dy-2Z7ny9-1}\nwixd{NW47t2dy-49wKDh-1}}}%
\nwixlogsorted{c}{{Proof step: $\forall y$, $y\in\varphi(\mathcal{F})\implies y\in\mathcal{F}$}{NW47t2dy-4OfaO1-1}{\nwixu{NW47t2dy-2Z7ny9-1}\nwixd{NW47t2dy-4OfaO1-1}}}%
\nwixlogsorted{c}{{Proof step: $\forall\varphi_{0}\in\Aut(G),\forall x$, $x\in\mathcal{F}\implies\varphi_{0}(x)\in\mathcal{F}$}{NW47t2dy-17zJkN-1}{\nwixu{NW47t2dy-2Z7ny9-1}\nwixd{NW47t2dy-17zJkN-1}}}%
...
\end{equation}
We take advantage of a lemma to prove
\begin{equation}
...
\nwused{\\{NW47t2dy-3N17ED-1}}\nwidentdefs{\\{{\nwixident{Th33}}{Th33}}}\nwidentuses{\\{{\nwixident{Automorphism}}{Automorphism}}\\{{\nwixident{characteristic}}{characteristic}}\\{{\nwixident{Def10}}{Def10}}\\{{\nwixident{LmMeet1}}{LmMeet1}}}\nwindexuse{\nwixident{Automorphism}}{Automorphism}{NW47t2dy-1wEepZ-1}\nwindexuse{\nwixident{characteristic}}{characteristic}{NW47t2dy-1wEepZ-1}\nwindexuse{\nwixident{Def10}}{Def10}{NW47t2dy-1wEepZ-1}\nwindexuse{\nwixident{LmMeet1}}{LmMeet1}{NW47t2dy-1wEepZ-1}\nwendcode{}\nwbegindocs{64}\nwdocspar
\begin{lemma}
Let $G$ be a nontrivial group with a maximal subgroup, let $\mathcal{F}$
be the collection of the sets underlying the maximal subgroups of $G$.
Then for any automorphism $\varphi\in\Aut(G)$, we have
$\varphi(\bigcap\mathcal{F})=\bigcap \mathcal{F}$.
\end{lemma}

\nwenddocs{}\nwbegincode{65}\sublabel{NW47t2dy-2Z7ny9-1}\nwmargintag{{\nwtagstyle{}\subpageref{NW47t2dy-2Z7ny9-1}}}\moddef{Lemma: if $G$ is nontrivial and has a maximal subgroup, then $\forall\varphi\in\Aut(G)$, $\varphi(U(\Phi(G))) = U(\Phi(G))$~{\nwtagstyle{}\subpageref{NW47t2dy-2Z7ny9-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NW47t2dy-1wEepZ-1}}\nwenddeflinemarkup
\nwlinkedidentc{LmMeet1}{NW47t2dy-2Z7ny9-1}:
(ex H being strict Subgroup of G st H is maximal) implies
for phi being \nwlinkedidentc{Automorphism}{NW1Nnu7l-4WeeL5-1} of G
holds phi .: meet\{A where A is Subset of G :
                  ex H being strict Subgroup of G
                  st A = the carrier of H & H is maximal\}
= meet\{A where A is Subset of G :
       ex H being strict Subgroup of G st A = the carrier of H & H is maximal\}
proof
  given H being strict Subgroup of G such that
  A1: H is maximal;
  let phi be \nwlinkedidentc{Automorphism}{NW1Nnu7l-4WeeL5-1} of G;
  A2: phi is one-to-one;
  ...
  \LA{}Proof step: $\forall\varphi_{0}\in\Aut(G),\forall x$, $x\in\mathcal{F}\implies\varphi_{0}(x)\in\mathcal{F}$~{\nwtagstyle{}\subpageref{NW47t2dy-17zJkN-1}}\RA{}

  for x being object st x in meet Fam
  holds x in phi .: meet Fam
  \LA{}Proof step: $\forall x$, $x\in\mathcal{F}\implies x\in\varphi(\mathcal{F})$~{\nwtagstyle{}\subpageref{NW47t2dy-49wKDh-1}}\RA{}
  then P2: meet Fam c= phi .: meet Fam by TARSKI:def 3;

  for y being object st y in phi .: meet Fam
  holds y in meet Fam
  \LA{}Proof step: $\forall y$, $y\in\varphi(\mathcal{F})\implies y\in\mathcal{F}$~{\nwtagstyle{}\subpageref{NW47t2dy-4OfaO1-1}}\RA{}
  then P1: phi .: meet Fam c= meet Fam by TARSKI:def 3;

  thus thesis by P1,P2,XBOOLE_0:def 10;
end;

\nwindexdefn{\nwixident{LmMeet1}}{LmMeet1}{NW47t2dy-2Z7ny9-1}\eatline
\nwused{\\{NW47t2dy-1wEepZ-1}}\nwidentdefs{\\{{\nwixident{LmMeet1}}{LmMeet1}}}\nwidentuses{\\{{\nwixident{Automorphism}}{Automorphism}}}\nwindexuse{\nwixident{Automorphism}}{Automorphism}{NW47t2dy-2Z7ny9-1}\nwendcode{}\nwbegindocs{66}\nwdocspar
\nwenddocs{}\nwbegincode{67}\sublabel{NW47t2dy-17zJkN-1}\nwmargintag{{\nwtagstyle{}\subpageref{NW47t2dy-17zJkN-1}}}\moddef{Proof step: $\forall\varphi_{0}\in\Aut(G),\forall x$, $x\in\mathcal{F}\implies\varphi_{0}(x)\in\mathcal{F}$~{\nwtagstyle{}\subpageref{NW47t2dy-17zJkN-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NW47t2dy-2Z7ny9-1}}\nwenddeflinemarkup
proof
  let phi0 be \nwlinkedidentc{Automorphism}{NW1Nnu7l-4WeeL5-1} of G;
  let x be object;
  ...
  proof
    ...
    C3: A0=A & ex H being strict Subgroup of G st A0 = the carrier of H & H is maximal
    by C1;
    consider K being strict Subgroup of G such that
    C4: A = the carrier of K & K is maximal
    by C3;
    consider psi being \nwlinkedidentc{Automorphism}{NW1Nnu7l-4WeeL5-1} of G such that
    ...
    Image(psi|K) is maximal by C4,C5,\nwlinkedidentc{Th31}{NW1Nnu7l-39Q49p-1};
...
\nwused{\\{NW47t2dy-2Z7ny9-1}}\nwidentuses{\\{{\nwixident{Automorphism}}{Automorphism}}\\{{\nwixident{Th31}}{Th31}}\\{{\nwixident{Th7}}{Th7}}}\nwindexuse{\nwixident{Automorphism}}{Automorphism}{NW47t2dy-17zJkN-1}\nwindexuse{\nwixident{Th31}}{Th31}{NW47t2dy-17zJkN-1}\nwindexuse{\nwixident{Th7}}{Th7}{NW47t2dy-17zJkN-1}\nwendcode{}\nwbegindocs{68}\nwdocspar

\nwenddocs{}\nwbegincode{69}\sublabel{NW47t2dy-49wKDh-1}\nwmargintag{{\nwtagstyle{}\subpageref{NW47t2dy-49wKDh-1}}}\moddef{Proof step: $\forall x$, $x\in\mathcal{F}\implies x\in\varphi(\mathcal{F})$~{\nwtagstyle{}\subpageref{NW47t2dy-49wKDh-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NW47t2dy-2Z7ny9-1}}\nwenddeflinemarkup
proof
  let x be object;
  assume B1: x in meet Fam;
  then carr H in Fam & for A1 holds A1 in Fam implies x in A1 by A1,SETFAM_1:def 1;
  then B2: x in H by STRUCT_0:def 5;
  then B3: x is Element of G by GROUP_2:42;
  reconsider psi = phi" as \nwlinkedidentc{Automorphism}{NW1Nnu7l-4WeeL5-1} of G by GROUP_6:62;
  B4: dom phi = UG & dom psi = UG by FUNCT_2:def 1;
  ...
  hence x in phi .: meet Fam by B6, A3, SETFAM_1:def 1;
end;

\nwused{\\{NW47t2dy-2Z7ny9-1}}\nwidentuses{\\{{\nwixident{Automorphism}}{Automorphism}}\\{{\nwixident{Lm11}}{Lm11}}}\nwindexuse{\nwixident{Automorphism}}{Automorphism}{NW47t2dy-49wKDh-1}\nwindexuse{\nwixident{Lm11}}{Lm11}{NW47t2dy-49wKDh-1}\nwendcode{}\nwbegindocs{70}\nwdocspar

\nwenddocs{}\nwbegincode{71}\sublabel{NW47t2dy-4OfaO1-1}\nwmargintag{{\nwtagstyle{}\subpageref{NW47t2dy-4OfaO1-1}}}\moddef{Proof step: $\forall y$, $y\in\varphi(\mathcal{F})\implies y\in\mathcal{F}$~{\nwtagstyle{}\subpageref{NW47t2dy-4OfaO1-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NW47t2dy-2Z7ny9-1}}\nwenddeflinemarkup
proof
  let y be object;
...
\nwused{\\{NW47t2dy-2Z7ny9-1}}\nwidentuses{\\{{\nwixident{Automorphism}}{Automorphism}}}\nwindexuse{\nwixident{Automorphism}}{Automorphism}{NW47t2dy-4OfaO1-1}\nwendcode{}\nwbegindocs{72}\nwdocspar
\nwenddocs{}
