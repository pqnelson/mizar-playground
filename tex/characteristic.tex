...
\nwenddocs{}\nwbegincode{1}\sublabel{NWoaARJ-KmSke-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWoaARJ-KmSke-1}}}\moddef{TEXT/group-22.miz~{\nwtagstyle{}\subpageref{NWoaARJ-KmSke-1}}}\endmoddef\nwstartdeflinemarkup\nwenddeflinemarkup
\LA{}License for \code{}group{\_}22.miz\edoc{}~{\nwtagstyle{}\subpageref{NWoaARJ-2EFGfY-1}}\RA{}

\LA{}Environment for \code{}group{\_}22.miz\edoc{}~{\nwtagstyle{}\subpageref{NW4bbsBH-FK1ys-1}}\RA{}

\LA{}\code{}group{\_}22.miz\edoc{} article body~{\nwtagstyle{}\subpageref{NW18nMBU-1Vve9X-1}}\RA{}
...
\nwenddocs{}\nwbegincode{3}\sublabel{NWoaARJ-1hUeyM-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWoaARJ-1hUeyM-1}}}\moddef{DICT/GROUP-22.VOC~{\nwtagstyle{}\subpageref{NWoaARJ-1hUeyM-1}}}\endmoddef\nwstartdeflinemarkup\nwprevnextdefs{\relax}{NW3Mfp8C-1hUeyM-1}\nwenddeflinemarkup

\nwalsodefined{\\{NW3Mfp8C-1hUeyM-1}\\{NW47t2dy-1hUeyM-1}}\nwnotused{DICT/GROUP-22.VOC}\nwendcode{}\nwbegindocs{4}\nwdocspar

\subsection*{License}
The license for the MML seems to be the same for each article, I will
just copy it over.

\nwenddocs{}\nwbegincode{5}\sublabel{NWoaARJ-2EFGfY-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWoaARJ-2EFGfY-1}}}\moddef{License for \code{}group{\_}22.miz\edoc{}~{\nwtagstyle{}\subpageref{NWoaARJ-2EFGfY-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NWoaARJ-KmSke-1}}\nwenddeflinemarkup
...
\nwenddocs{}\nwbegincode{1}\sublabel{NW4bbsBH-FK1ys-1}\nwmargintag{{\nwtagstyle{}\subpageref{NW4bbsBH-FK1ys-1}}}\moddef{Environment for \code{}group{\_}22.miz\edoc{}~{\nwtagstyle{}\subpageref{NW4bbsBH-FK1ys-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NWoaARJ-KmSke-1}}\nwenddeflinemarkup
environ

 \LA{}\code{}group{\_}22.miz\edoc{} vocabularies~{\nwtagstyle{}\subpageref{NW4bbsBH-1uaatY-1}}\RA{};
 \LA{}\code{}group{\_}22.miz\edoc{} constructors~{\nwtagstyle{}\subpageref{NW4bbsBH-BOc6W-1}}\RA{};
 \LA{}\code{}group{\_}22.miz\edoc{} notations~{\nwtagstyle{}\subpageref{NW4bbsBH-4R7z6a-1}}\RA{};
 \LA{}\code{}group{\_}22.miz\edoc{} registrations~{\nwtagstyle{}\subpageref{NW4bbsBH-4Kp0yM-1}}\RA{};
 \LA{}\code{}group{\_}22.miz\edoc{} requirements~{\nwtagstyle{}\subpageref{NW4bbsBH-tou4m-1}}\RA{};
 \LA{}\code{}group{\_}22.miz\edoc{} definitions~{\nwtagstyle{}\subpageref{NW4bbsBH-3c241H-1}}\RA{};
 \LA{}\code{}group{\_}22.miz\edoc{} equalities~{\nwtagstyle{}\subpageref{NW4bbsBH-RMPxd-1}}\RA{};
 \LA{}\code{}group{\_}22.miz\edoc{} expansions~{\nwtagstyle{}\subpageref{NW4bbsBH-22IB3u-1}}\RA{};
 \LA{}\code{}group{\_}22.miz\edoc{} theorems~{\nwtagstyle{}\subpageref{NW4bbsBH-lydFc-1}}\RA{};
 \LA{}\code{}group{\_}22.miz\edoc{} schemes~{\nwtagstyle{}\subpageref{NW4bbsBH-4ZgZmN-1}}\RA{};
\nwused{\\{NWoaARJ-KmSke-1}}\nwendcode{}\nwbegindocs{2}\nwdocspar
...
\nwenddocs{}\nwbegincode{3}\sublabel{NW4bbsBH-1uaatY-1}\nwmargintag{{\nwtagstyle{}\subpageref{NW4bbsBH-1uaatY-1}}}\moddef{\code{}group{\_}22.miz\edoc{} vocabularies~{\nwtagstyle{}\subpageref{NW4bbsBH-1uaatY-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NW4bbsBH-FK1ys-1}}\nwenddeflinemarkup
...
\nwenddocs{}\nwbegincode{11}\sublabel{NW4bbsBH-BOc6W-1}\nwmargintag{{\nwtagstyle{}\subpageref{NW4bbsBH-BOc6W-1}}}\moddef{\code{}group{\_}22.miz\edoc{} constructors~{\nwtagstyle{}\subpageref{NW4bbsBH-BOc6W-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NW4bbsBH-FK1ys-1}}\nwenddeflinemarkup
constructors \LA{}Set theoretic constructors for \code{}group{\_}22.miz\edoc{}~{\nwtagstyle{}\subpageref{NW4bbsBH-4OYzVK-1}}\RA{}
  \LA{}Number constructors for \code{}group{\_}22.miz\edoc{}~{\nwtagstyle{}\subpageref{NW4bbsBH-2Rb2PP-1}}\RA{}
  \LA{}Group theory constructors for \code{}group{\_}22.miz\edoc{}~{\nwtagstyle{}\subpageref{NW4bbsBH-4A8g9y-1}}\RA{}
\nwused{\\{NW4bbsBH-FK1ys-1}}\nwendcode{}\nwbegindocs{12}\nwdocspar

\nwenddocs{}\nwbegincode{13}\sublabel{NW4bbsBH-4OYzVK-1}\nwmargintag{{\nwtagstyle{}\subpageref{NW4bbsBH-4OYzVK-1}}}\moddef{Set theoretic constructors for \code{}group{\_}22.miz\edoc{}~{\nwtagstyle{}\subpageref{NW4bbsBH-4OYzVK-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NW4bbsBH-BOc6W-1}}\nwenddeflinemarkup
TARSKI, XBOOLE_0, ZFMISC_1, SUBSET_1, RELAT_1, FUNCT_1,
RELSET_1, PARTFUN1, FUNCT_2, FUNCOP_1, FINSEQ_1, FINSEQ_2, FINSOP_1,
\nwused{\\{NW4bbsBH-BOc6W-1}}\nwendcode{}\nwbegindocs{14}\nwdocspar

\nwenddocs{}\nwbegincode{15}\sublabel{NW4bbsBH-2Rb2PP-1}\nwmargintag{{\nwtagstyle{}\subpageref{NW4bbsBH-2Rb2PP-1}}}\moddef{Number constructors for \code{}group{\_}22.miz\edoc{}~{\nwtagstyle{}\subpageref{NW4bbsBH-2Rb2PP-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NW4bbsBH-BOc6W-1}}\nwenddeflinemarkup
...
\nwenddocs{}\nwbegincode{17}\sublabel{NW4bbsBH-4A8g9y-1}\nwmargintag{{\nwtagstyle{}\subpageref{NW4bbsBH-4A8g9y-1}}}\moddef{Group theory constructors for \code{}group{\_}22.miz\edoc{}~{\nwtagstyle{}\subpageref{NW4bbsBH-4A8g9y-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NW4bbsBH-BOc6W-1}}\nwenddeflinemarkup
...
\nwenddocs{}\nwbegincode{19}\sublabel{NW4bbsBH-4R7z6a-1}\nwmargintag{{\nwtagstyle{}\subpageref{NW4bbsBH-4R7z6a-1}}}\moddef{\code{}group{\_}22.miz\edoc{} notations~{\nwtagstyle{}\subpageref{NW4bbsBH-4R7z6a-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NW4bbsBH-FK1ys-1}}\nwenddeflinemarkup
...
\nwenddocs{}\nwbegincode{21}\sublabel{NW4bbsBH-4Kp0yM-1}\nwmargintag{{\nwtagstyle{}\subpageref{NW4bbsBH-4Kp0yM-1}}}\moddef{\code{}group{\_}22.miz\edoc{} registrations~{\nwtagstyle{}\subpageref{NW4bbsBH-4Kp0yM-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NW4bbsBH-FK1ys-1}}\nwenddeflinemarkup
registrations \LA{}Register set theoretic clusters for \code{}group{\_}22.miz\edoc{}~{\nwtagstyle{}\subpageref{NW4bbsBH-4BFxVB-1}}\RA{},
  \LA{}Register number clusters for \code{}group{\_}22.miz\edoc{}~{\nwtagstyle{}\subpageref{NW4bbsBH-3CpoAk-1}}\RA{},
  \LA{}Register group theoretic clusters for \code{}group{\_}22.miz\edoc{}~{\nwtagstyle{}\subpageref{NW4bbsBH-2mrFCy-1}}\RA{}
\nwused{\\{NW4bbsBH-FK1ys-1}}\nwendcode{}\nwbegindocs{22}\nwdocspar
...
\nwenddocs{}\nwbegincode{23}\sublabel{NW4bbsBH-4BFxVB-1}\nwmargintag{{\nwtagstyle{}\subpageref{NW4bbsBH-4BFxVB-1}}}\moddef{Register set theoretic clusters for \code{}group{\_}22.miz\edoc{}~{\nwtagstyle{}\subpageref{NW4bbsBH-4BFxVB-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NW4bbsBH-4Kp0yM-1}}\nwenddeflinemarkup
XBOOLE_0, RELAT_1, FUNCT_1, PARTFUN1, RELSET_1, FUNCT_2
\nwused{\\{NW4bbsBH-4Kp0yM-1}}\nwendcode{}\nwbegindocs{24}\nwdocspar

\nwenddocs{}\nwbegincode{25}\sublabel{NW4bbsBH-3CpoAk-1}\nwmargintag{{\nwtagstyle{}\subpageref{NW4bbsBH-3CpoAk-1}}}\moddef{Register number clusters for \code{}group{\_}22.miz\edoc{}~{\nwtagstyle{}\subpageref{NW4bbsBH-3CpoAk-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NW4bbsBH-4Kp0yM-1}}\nwenddeflinemarkup
...
\nwenddocs{}\nwbegincode{27}\sublabel{NW4bbsBH-2mrFCy-1}\nwmargintag{{\nwtagstyle{}\subpageref{NW4bbsBH-2mrFCy-1}}}\moddef{Register group theoretic clusters for \code{}group{\_}22.miz\edoc{}~{\nwtagstyle{}\subpageref{NW4bbsBH-2mrFCy-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NW4bbsBH-4Kp0yM-1}}\nwenddeflinemarkup
...
\nwenddocs{}\nwbegincode{29}\sublabel{NW4bbsBH-3c241H-1}\nwmargintag{{\nwtagstyle{}\subpageref{NW4bbsBH-3c241H-1}}}\moddef{\code{}group{\_}22.miz\edoc{} definitions~{\nwtagstyle{}\subpageref{NW4bbsBH-3c241H-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NW4bbsBH-FK1ys-1}}\nwenddeflinemarkup
definitions \LA{}Include set theoretic definitions for \code{}group{\_}22.miz\edoc{}~{\nwtagstyle{}\subpageref{NW4bbsBH-2hxaIL-1}}\RA{},
  \LA{}Group theoretic definitions for \code{}group{\_}22.miz\edoc{}~{\nwtagstyle{}\subpageref{NW4bbsBH-2qQNX4-1}}\RA{}
\nwused{\\{NW4bbsBH-FK1ys-1}}\nwendcode{}\nwbegindocs{30}\nwdocspar
...
\nwenddocs{}\nwbegincode{31}\sublabel{NW4bbsBH-2hxaIL-1}\nwmargintag{{\nwtagstyle{}\subpageref{NW4bbsBH-2hxaIL-1}}}\moddef{Include set theoretic definitions for \code{}group{\_}22.miz\edoc{}~{\nwtagstyle{}\subpageref{NW4bbsBH-2hxaIL-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NW4bbsBH-3c241H-1}}\nwenddeflinemarkup
TARSKI, SUBSET_1, FUNCT_1, FUNCT_2, ARYTM_2, FINSEQ_1, INT_1
\nwused{\\{NW4bbsBH-3c241H-1}}\nwendcode{}\nwbegindocs{32}\nwdocspar

%\M
But we also want to use facts concerning normal subgroups ({\Tt{}GROUP{\_}3\nwendquote})
and the automorphism group $\aut(G)$ ({\Tt{}AUTGROUP\nwendquote}).

\nwenddocs{}\nwbegincode{33}\sublabel{NW4bbsBH-2qQNX4-1}\nwmargintag{{\nwtagstyle{}\subpageref{NW4bbsBH-2qQNX4-1}}}\moddef{Group theoretic definitions for \code{}group{\_}22.miz\edoc{}~{\nwtagstyle{}\subpageref{NW4bbsBH-2qQNX4-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NW4bbsBH-3c241H-1}}\nwenddeflinemarkup
...
\nwenddocs{}\nwbegincode{35}\sublabel{NW4bbsBH-lydFc-1}\nwmargintag{{\nwtagstyle{}\subpageref{NW4bbsBH-lydFc-1}}}\moddef{\code{}group{\_}22.miz\edoc{} theorems~{\nwtagstyle{}\subpageref{NW4bbsBH-lydFc-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NW4bbsBH-FK1ys-1}}\nwenddeflinemarkup
theorems
  \LA{}Import set-theoretic theorems for \code{}group{\_}22.miz\edoc{}~{\nwtagstyle{}\subpageref{NW4bbsBH-2UoAMk-1}}\RA{},
  \LA{}Import group-theoretic theorems for \code{}group{\_}22.miz\edoc{}~{\nwtagstyle{}\subpageref{NW4bbsBH-3iw38Z-1}}\RA{}
\nwused{\\{NW4bbsBH-FK1ys-1}}\nwendcode{}\nwbegindocs{36}\nwdocspar
...
\nwenddocs{}\nwbegincode{37}\sublabel{NW4bbsBH-2UoAMk-1}\nwmargintag{{\nwtagstyle{}\subpageref{NW4bbsBH-2UoAMk-1}}}\moddef{Import set-theoretic theorems for \code{}group{\_}22.miz\edoc{}~{\nwtagstyle{}\subpageref{NW4bbsBH-2UoAMk-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NW4bbsBH-lydFc-1}}\nwenddeflinemarkup
TARSKI, RELSET_1, FUNCT_1, FUNCT_2, XBOOLE_0, INT_2, SETFAM_1, FINSEQ_3,
PARTFUN1, ORDINAL1, ZFMISC_1, NAT_D, INT_1
\nwused{\\{NW4bbsBH-lydFc-1}}\nwendcode{}\nwbegindocs{38}\nwdocspar

%\M
Again, we import the usual group theoretic theorems.
\nwenddocs{}\nwbegincode{39}\sublabel{NW4bbsBH-3iw38Z-1}\nwmargintag{{\nwtagstyle{}\subpageref{NW4bbsBH-3iw38Z-1}}}\moddef{Import group-theoretic theorems for \code{}group{\_}22.miz\edoc{}~{\nwtagstyle{}\subpageref{NW4bbsBH-3iw38Z-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NW4bbsBH-lydFc-1}}\nwenddeflinemarkup
...
\nwenddocs{}\nwbegincode{41}\sublabel{NW4bbsBH-4ZgZmN-1}\nwmargintag{{\nwtagstyle{}\subpageref{NW4bbsBH-4ZgZmN-1}}}\moddef{\code{}group{\_}22.miz\edoc{} schemes~{\nwtagstyle{}\subpageref{NW4bbsBH-4ZgZmN-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NW4bbsBH-FK1ys-1}}\nwenddeflinemarkup
...
\nwenddocs{}\nwbegincode{43}\sublabel{NW4bbsBH-RMPxd-1}\nwmargintag{{\nwtagstyle{}\subpageref{NW4bbsBH-RMPxd-1}}}\moddef{\code{}group{\_}22.miz\edoc{} equalities~{\nwtagstyle{}\subpageref{NW4bbsBH-RMPxd-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NW4bbsBH-FK1ys-1}}\nwenddeflinemarkup
...
\nwenddocs{}\nwbegincode{45}\sublabel{NW4bbsBH-22IB3u-1}\nwmargintag{{\nwtagstyle{}\subpageref{NW4bbsBH-22IB3u-1}}}\moddef{\code{}group{\_}22.miz\edoc{} expansions~{\nwtagstyle{}\subpageref{NW4bbsBH-22IB3u-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NW4bbsBH-FK1ys-1}}\nwenddeflinemarkup
...
\nwenddocs{}\nwbegincode{47}\sublabel{NW4bbsBH-tou4m-1}\nwmargintag{{\nwtagstyle{}\subpageref{NW4bbsBH-tou4m-1}}}\moddef{\code{}group{\_}22.miz\edoc{} requirements~{\nwtagstyle{}\subpageref{NW4bbsBH-tou4m-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NW4bbsBH-FK1ys-1}}\nwenddeflinemarkup
...
\nwenddocs{}\nwbegincode{1}\sublabel{NW18nMBU-1Vve9X-1}\nwmargintag{{\nwtagstyle{}\subpageref{NW18nMBU-1Vve9X-1}}}\moddef{\code{}group{\_}22.miz\edoc{} article body~{\nwtagstyle{}\subpageref{NW18nMBU-1Vve9X-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NWoaARJ-KmSke-1}}\nwenddeflinemarkup
begin :: Preparatory Work
\LA{}Helper lemmas and registrations for \code{}group{\_}22.miz\edoc{}~{\nwtagstyle{}\subpageref{NW18nMBU-2pzjB9-1}}\RA{}
...
\nwused{\\{NWoaARJ-KmSke-1}}\nwidentuses{\\{{\nwixident{Centralizer}}{Centralizer}}}\nwindexuse{\nwixident{Centralizer}}{Centralizer}{NW18nMBU-1Vve9X-1}\nwendcode{}\nwbegindocs{2}\nwdocspar
...
\nwenddocs{}\nwbegincode{3}\sublabel{NW18nMBU-2pzjB9-1}\nwmargintag{{\nwtagstyle{}\subpageref{NW18nMBU-2pzjB9-1}}}\moddef{Helper lemmas and registrations for \code{}group{\_}22.miz\edoc{}~{\nwtagstyle{}\subpageref{NW18nMBU-2pzjB9-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NW18nMBU-1Vve9X-1}}\nwenddeflinemarkup
reserve X for set;
...
proof
  ...
  thus H is \nwlinkedidentc{proper}{NW18nMBU-RKCxZ-1} implies UG \\ UH is non empty set
...
\nwenddocs{}\nwbegincode{7}\sublabel{NW3Mfp8C-1hUeyM-1}\nwmargintag{{\nwtagstyle{}\subpageref{NW3Mfp8C-1hUeyM-1}}}\moddef{DICT/GROUP-22.VOC~{\nwtagstyle{}\subpageref{NWoaARJ-1hUeyM-1}}}\plusendmoddef\nwstartdeflinemarkup\nwprevnextdefs{NWoaARJ-1hUeyM-1}{NW47t2dy-1hUeyM-1}\nwenddeflinemarkup
Vinner
Vouter
\nwendcode{}\nwbegindocs{8}\nwdocspar
...
\nwindexdefn{\nwixident{Def3}}{Def3}{NW47t2dy-qejLV-1}\nwindexdefn{\nwixident{characteristic}}{characteristic}{NW47t2dy-qejLV-1}\eatline
...
\nwenddocs{}\nwbegincode{5}\sublabel{NW47t2dy-1hUeyM-1}\nwmargintag{{\nwtagstyle{}\subpageref{NW47t2dy-1hUeyM-1}}}\moddef{DICT/GROUP-22.VOC~{\nwtagstyle{}\subpageref{NWoaARJ-1hUeyM-1}}}\plusendmoddef\nwstartdeflinemarkup\nwprevnextdefs{NW3Mfp8C-1hUeyM-1}{\relax}\nwenddeflinemarkup
Vcharacteristic
\nwendcode{}\nwbegindocs{6}\nwdocspar
...
\nwenddocs{}\nwbegincode{103}\sublabel{NW47t2dy-412Ya0-1}\nwmargintag{{\nwtagstyle{}\subpageref{NW47t2dy-412Ya0-1}}}\moddef{Proof: ${\rm Commutators}(H,K)\subset\varphi({\rm Commutators}(H,K))$~{\nwtagstyle{}\subpageref{NW47t2dy-412Ya0-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NW47t2dy-41VHSD-1}}\nwenddeflinemarkup
proof
  let x be object;
...
\nwused{\\{NW47t2dy-41VHSD-1}}\nwidentuses{\\{{\nwixident{Automorphism}}{Automorphism}}\\{{\nwixident{Th4}}{Th4}}\\{{\nwixident{Th50}}{Th50}}}\nwindexuse{\nwixident{Automorphism}}{Automorphism}{NW47t2dy-412Ya0-1}\nwindexuse{\nwixident{Th4}}{Th4}{NW47t2dy-412Ya0-1}\nwindexuse{\nwixident{Th50}}{Th50}{NW47t2dy-412Ya0-1}\nwendcode{}\nwbegindocs{104}\nwdocspar
...
\nwenddocs{}\nwbegincode{105}\sublabel{NW47t2dy-1RjAjC-1}\nwmargintag{{\nwtagstyle{}\subpageref{NW47t2dy-1RjAjC-1}}}\moddef{Proof: ${\rm Commutators}(H,K)\supset\varphi({\rm Commutators}(H,K))$~{\nwtagstyle{}\subpageref{NW47t2dy-1RjAjC-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NW47t2dy-41VHSD-1}}\nwenddeflinemarkup
proof
  let y be object;
...
\nwused{\\{NW47t2dy-41VHSD-1}}\nwidentuses{\\{{\nwixident{Th50}}{Th50}}}\nwindexuse{\nwixident{Th50}}{Th50}{NW47t2dy-1RjAjC-1}\nwendcode{}\nwbegindocs{106}\nwdocspar
...
\nwixlogsorted{c}{{\code{}group{\_}22.miz\edoc{} article body}{NW18nMBU-1Vve9X-1}{\nwixu{NWoaARJ-KmSke-1}\nwixd{NW18nMBU-1Vve9X-1}}}%
\nwixlogsorted{c}{{\code{}group{\_}22.miz\edoc{} constructors}{NW4bbsBH-BOc6W-1}{\nwixu{NW4bbsBH-FK1ys-1}\nwixd{NW4bbsBH-BOc6W-1}}}%
\nwixlogsorted{c}{{\code{}group{\_}22.miz\edoc{} definitions}{NW4bbsBH-3c241H-1}{\nwixu{NW4bbsBH-FK1ys-1}\nwixd{NW4bbsBH-3c241H-1}}}%
\nwixlogsorted{c}{{\code{}group{\_}22.miz\edoc{} equalities}{NW4bbsBH-RMPxd-1}{\nwixu{NW4bbsBH-FK1ys-1}\nwixd{NW4bbsBH-RMPxd-1}}}%
\nwixlogsorted{c}{{\code{}group{\_}22.miz\edoc{} expansions}{NW4bbsBH-22IB3u-1}{\nwixu{NW4bbsBH-FK1ys-1}\nwixd{NW4bbsBH-22IB3u-1}}}%
\nwixlogsorted{c}{{\code{}group{\_}22.miz\edoc{} notations}{NW4bbsBH-4R7z6a-1}{\nwixu{NW4bbsBH-FK1ys-1}\nwixd{NW4bbsBH-4R7z6a-1}}}%
\nwixlogsorted{c}{{\code{}group{\_}22.miz\edoc{} registrations}{NW4bbsBH-4Kp0yM-1}{\nwixu{NW4bbsBH-FK1ys-1}\nwixd{NW4bbsBH-4Kp0yM-1}}}%
\nwixlogsorted{c}{{\code{}group{\_}22.miz\edoc{} requirements}{NW4bbsBH-tou4m-1}{\nwixu{NW4bbsBH-FK1ys-1}\nwixd{NW4bbsBH-tou4m-1}}}%
\nwixlogsorted{c}{{\code{}group{\_}22.miz\edoc{} schemes}{NW4bbsBH-4ZgZmN-1}{\nwixu{NW4bbsBH-FK1ys-1}\nwixd{NW4bbsBH-4ZgZmN-1}}}%
\nwixlogsorted{c}{{\code{}group{\_}22.miz\edoc{} theorems}{NW4bbsBH-lydFc-1}{\nwixu{NW4bbsBH-FK1ys-1}\nwixd{NW4bbsBH-lydFc-1}}}%
\nwixlogsorted{c}{{\code{}group{\_}22.miz\edoc{} vocabularies}{NW4bbsBH-1uaatY-1}{\nwixu{NW4bbsBH-FK1ys-1}\nwixd{NW4bbsBH-1uaatY-1}}}%
\nwixlogsorted{c}{{Automorphisms of Groups}{NW1Nnu7l-1CMOm-1}{\nwixu{NW18nMBU-1Vve9X-1}\nwixd{NW1Nnu7l-1CMOm-1}}}%
...
\nwixlogsorted{c}{{DICT/GROUP-22.VOC}{NWoaARJ-1hUeyM-1}{\nwixd{NWoaARJ-1hUeyM-1}\nwixd{NW3Mfp8C-1hUeyM-1}\nwixd{NW47t2dy-1hUeyM-1}}}%
\nwixlogsorted{c}{{Environment for \code{}group{\_}22.miz\edoc{}}{NW4bbsBH-FK1ys-1}{\nwixu{NWoaARJ-KmSke-1}\nwixd{NW4bbsBH-FK1ys-1}}}%
...
\nwixlogsorted{c}{{Group theoretic definitions for \code{}group{\_}22.miz\edoc{}}{NW4bbsBH-2qQNX4-1}{\nwixu{NW4bbsBH-3c241H-1}\nwixd{NW4bbsBH-2qQNX4-1}}}%
\nwixlogsorted{c}{{Group theory constructors for \code{}group{\_}22.miz\edoc{}}{NW4bbsBH-4A8g9y-1}{\nwixu{NW4bbsBH-BOc6W-1}\nwixd{NW4bbsBH-4A8g9y-1}}}%
\nwixlogsorted{c}{{Helper lemmas and registrations for \code{}group{\_}22.miz\edoc{}}{NW18nMBU-2pzjB9-1}{\nwixu{NW18nMBU-1Vve9X-1}\nwixd{NW18nMBU-2pzjB9-1}}}%
\nwixlogsorted{c}{{Import group-theoretic theorems for \code{}group{\_}22.miz\edoc{}}{NW4bbsBH-3iw38Z-1}{\nwixu{NW4bbsBH-lydFc-1}\nwixd{NW4bbsBH-3iw38Z-1}}}%
\nwixlogsorted{c}{{Import set-theoretic theorems for \code{}group{\_}22.miz\edoc{}}{NW4bbsBH-2UoAMk-1}{\nwixu{NW4bbsBH-lydFc-1}\nwixd{NW4bbsBH-2UoAMk-1}}}%
\nwixlogsorted{c}{{Include set theoretic definitions for \code{}group{\_}22.miz\edoc{}}{NW4bbsBH-2hxaIL-1}{\nwixu{NW4bbsBH-3c241H-1}\nwixd{NW4bbsBH-2hxaIL-1}}}%
...
\nwixlogsorted{c}{{License for \code{}group{\_}22.miz\edoc{}}{NWoaARJ-2EFGfY-1}{\nwixu{NWoaARJ-KmSke-1}\nwixd{NWoaARJ-2EFGfY-1}}}%
...
\nwixlogsorted{c}{{Number constructors for \code{}group{\_}22.miz\edoc{}}{NW4bbsBH-2Rb2PP-1}{\nwixu{NW4bbsBH-BOc6W-1}\nwixd{NW4bbsBH-2Rb2PP-1}}}%
...
\nwixlogsorted{c}{{Proof: ${\rm Commutators}(H,K)\subset\varphi({\rm Commutators}(H,K))$}{NW47t2dy-412Ya0-1}{\nwixu{NW47t2dy-41VHSD-1}\nwixd{NW47t2dy-412Ya0-1}}}%
\nwixlogsorted{c}{{Proof: ${\rm Commutators}(H,K)\supset\varphi({\rm Commutators}(H,K))$}{NW47t2dy-1RjAjC-1}{\nwixu{NW47t2dy-41VHSD-1}\nwixd{NW47t2dy-1RjAjC-1}}}%
...
\nwixlogsorted{c}{{Register group theoretic clusters for \code{}group{\_}22.miz\edoc{}}{NW4bbsBH-2mrFCy-1}{\nwixu{NW4bbsBH-4Kp0yM-1}\nwixd{NW4bbsBH-2mrFCy-1}}}%
\nwixlogsorted{c}{{Register number clusters for \code{}group{\_}22.miz\edoc{}}{NW4bbsBH-3CpoAk-1}{\nwixu{NW4bbsBH-4Kp0yM-1}\nwixd{NW4bbsBH-3CpoAk-1}}}%
\nwixlogsorted{c}{{Register set theoretic clusters for \code{}group{\_}22.miz\edoc{}}{NW4bbsBH-4BFxVB-1}{\nwixu{NW4bbsBH-4Kp0yM-1}\nwixd{NW4bbsBH-4BFxVB-1}}}%
...
\nwixlogsorted{c}{{Set theoretic constructors for \code{}group{\_}22.miz\edoc{}}{NW4bbsBH-4OYzVK-1}{\nwixu{NW4bbsBH-BOc6W-1}\nwixd{NW4bbsBH-4OYzVK-1}}}%
...
\nwixlogsorted{c}{{TEXT/group-22.miz}{NWoaARJ-KmSke-1}{\nwixd{NWoaARJ-KmSke-1}}}%
