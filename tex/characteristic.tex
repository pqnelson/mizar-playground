...
proof
  ...
  hence thesis by A3,GROUP_6:49,FUNCT_1:def 3;
end;
...
proof
  ...
  hence phi.x is Element of G by A2,XBOOLE_0:def 5, FUNCT_1:def 3;
end;
\nwused{\\{NW1Nnu7l-39h8sj-1}}\nwendcode{}\nwbegindocs{62}\nwdocspar
...
proof
  ...
  by STRUCT_0:def 5;
  then rng(phi|Z) c= the carrier of Z;
...
proof
  ...
  proof
    ...
    dom f = the carrier of G1 & h in H & h in G1 by A1, B4;
  ...
  proof
    ...
    B3: g in (f.:H)
    by GROUP_2:103;
    g in Image(f|H) by B3,GRSOLV_1:def 3;
    ...
    then a*x in the carrier of G1 & dom f = the carrier of G1;
    then (a*x) in dom f & (a*x) in a*H & y=f.(a*x) by B7,B8;
...
proof
  ...
  proof
    ...
    dom f = the carrier of G1 by FUNCT_2:def 1;
    then x*a in the carrier of G1 & dom f = the carrier of G1;
    then (x*a) in dom f & (x*a) in H*a & y=f.(x*a) by B7,B8;
...
proof
  ...
  proof
    ...
    then phi.h * phi.k in carr H*carr K;
...
proof
  ...
  proof
    ...
    phi.([. a,b .]) = phi.(psi.x) by B6
                   .= g by \nwlinkedidentc{Th4}{NW18nMBU-1Brdpy-1};
    then B7: x = phi.([. a,b .]);
    [. a, b .] in commutators(H,K) by B4,B5;
    then phi.([. a,b .]) in phi .: commutators(H,K) by A1,FUNCT_1:def 6;
  ...
  proof
    ...
    hence y in commutators(H,K) by B2,B6,B7;
  end;
...
proof
  ...
  A6: for N being strict normal Subgroup of G() st carr N in Fam holds P[N]
  proof
    let N be strict normal Subgroup of G();
...
proof
  ...
  hence the carrier of N = meet X by A4;
end;
