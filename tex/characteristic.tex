...
\LA{}Lemma: $H\subgroup G$, $H$ is trivial implies $H=\trivialSubgroup_{G}$~{\nwtagstyle{}\subpageref{NW18nMBU-3k2d9L-1}}\RA{}
...
\nwindexdefn{\nwixident{Lm5}}{Lm5}{NW18nMBU-34x7vU-1}\eatline
\nwused{\\{NW18nMBU-oqDk7-1}}\nwidentdefs{\\{{\nwixident{Lm5}}{Lm5}}}\nwendcode{}\nwbegindocs{16}\nwdocspar
...
proof
  ...
  y = (g").(g.y) by A1,FUNCT_2:26
   .= f.((f").y) by \nwlinkedidentc{Lm5}{NW18nMBU-34x7vU-1},A1;
  hence thesis;
end;

\nwindexdefn{\nwixident{Lm6}}{Lm6}{NW18nMBU-2GAoBc-1}\eatline
\nwused{\\{NW18nMBU-oqDk7-1}}\nwidentdefs{\\{{\nwixident{Lm6}}{Lm6}}}\nwidentuses{\\{{\nwixident{Lm5}}{Lm5}}}\nwindexuse{\nwixident{Lm5}}{Lm5}{NW18nMBU-2GAoBc-1}\nwendcode{}\nwbegindocs{20}\nwdocspar
...
\nwindexdefn{\nwixident{Lm7}}{Lm7}{NW18nMBU-41PUYF-1}\eatline
\nwused{\\{NW18nMBU-oqDk7-1}}\nwidentdefs{\\{{\nwixident{Lm7}}{Lm7}}}\nwendcode{}\nwbegindocs{22}\nwdocspar
...
\nwindexdefn{\nwixident{Lm14}}{Lm14}{NW18nMBU-NeCDP-1}\eatline
...
\nwenddocs{}\nwbegincode{33}\sublabel{NW18nMBU-3k2d9L-1}\nwmargintag{{\nwtagstyle{}\subpageref{NW18nMBU-3k2d9L-1}}}\moddef{Lemma: $H\subgroup G$, $H$ is trivial implies $H=\trivialSubgroup_{G}$~{\nwtagstyle{}\subpageref{NW18nMBU-3k2d9L-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NW18nMBU-oqDk7-1}}\nwenddeflinemarkup
\nwlinkedidentc{Lm9}{NW18nMBU-3k2d9L-1}:
  for G being Group
  for H being Subgroup of G
  st H is \nwlinkedidentc{trivial}{NW18nMBU-47kVo6-1}
...
proof
  ...
  let H be Subgroup of G;
  assume H is \nwlinkedidentc{trivial}{NW18nMBU-47kVo6-1};
  then the multMagma of H = (1).H by Lm8
                         .= (1).G by GROUP_2:63;
  hence thesis;
end;


\nwindexdefn{\nwixident{Lm9}}{Lm9}{NW18nMBU-3k2d9L-1}\eatline
\nwused{\\{NW18nMBU-oqDk7-1}}\nwidentdefs{\\{{\nwixident{Lm9}}{Lm9}}}\nwidentuses{\\{{\nwixident{trivial}}{trivial}}}\nwindexuse{\nwixident{trivial}}{trivial}{NW18nMBU-3k2d9L-1}\nwendcode{}\nwbegindocs{34}\nwdocspar
\begin{lemma}
...
\nwindexdefn{\nwixident{Lm10}}{Lm10}{NW18nMBU-26Ljt0-1}\eatline
\nwused{\\{NW18nMBU-oqDk7-1}}\nwidentdefs{\\{{\nwixident{Lm10}}{Lm10}}}\nwidentuses{\\{{\nwixident{Lm9}}{Lm9}}\\{{\nwixident{trivial}}{trivial}}}\nwindexuse{\nwixident{Lm9}}{Lm9}{NW18nMBU-26Ljt0-1}\nwindexuse{\nwixident{trivial}}{trivial}{NW18nMBU-26Ljt0-1}\nwendcode{}\nwbegindocs{36}\nwdocspar
\begin{lemma}
...
\nwindexdefn{\nwixident{Lm11}}{Lm11}{NW18nMBU-zF0jx-1}\eatline
\nwused{\\{NW18nMBU-oqDk7-1}}\nwidentdefs{\\{{\nwixident{Lm11}}{Lm11}}}\nwidentuses{\\{{\nwixident{Lm9}}{Lm9}}\\{{\nwixident{trivial}}{trivial}}}\nwindexuse{\nwixident{Lm9}}{Lm9}{NW18nMBU-zF0jx-1}\nwindexuse{\nwixident{trivial}}{trivial}{NW18nMBU-zF0jx-1}\nwendcode{}\nwbegindocs{38}\nwdocspar
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\nwindexdefn{\nwixident{Lm12}}{Lm12}{NW18nMBU-2LrGAr-1}\eatline
...
\nwindexdefn{\nwixident{Lm13}}{Lm13}{NW18nMBU-2cWeD5-1}\eatline
...
proof
  assume A1: H is \nwlinkedidentc{proper}{NW18nMBU-RKCxZ-1};
  UH c= UG & UH <> UG by A1,\nwlinkedidentc{Lm12}{NW18nMBU-2LrGAr-1}, GROUP_2:def 5;
...
\nwlinkedidentc{Lm14}{NW18nMBU-NeCDP-1}:
  for G being Group
  for H being Subgroup of G
  st H is maximal
  holds H is \nwlinkedidentc{proper}{NW18nMBU-RKCxZ-1} by GROUP_4:def 6;

\nwindexdefn{\nwixident{Lm14}}{Lm14}{NW18nMBU-KtuAy-1}\eatline
...
\nwlinkedidentc{Lm16}{NW1Nnu7l-3CeuwY-1}: H is Subgroup of (1).G implies the multMagma of H = the multMagma of (1).G
proof
...
\nwindexdefn{\nwixident{Lm16}}{Lm16}{NW1Nnu7l-3CeuwY-1}\eatline
...
\nwlinkedidentc{Lm17}{NW1Nnu7l-2Beici-1}:
...
proof
  ...
  then Ker(phi|H) = (1).G by \nwlinkedidentc{Lm16}{NW1Nnu7l-3CeuwY-1}
                 .= (1).H by GROUP_2:63;
  hence (phi|H) is one-to-one by GROUP_6:56;
end;

\nwindexdefn{\nwixident{Lm17}}{Lm17}{NW1Nnu7l-2Beici-1}\eatline
\nwused{\\{NW1Nnu7l-32pmQO-1}}\nwidentdefs{\\{{\nwixident{Lm17}}{Lm17}}}\nwidentuses{\\{{\nwixident{Lm16}}{Lm16}}\\{{\nwixident{Th9}}{Th9}}}\nwindexuse{\nwixident{Lm16}}{Lm16}{NW1Nnu7l-2Beici-1}\nwindexuse{\nwixident{Th9}}{Th9}{NW1Nnu7l-2Beici-1}\nwendcode{}\nwbegindocs{22}\nwdocspar
...
\nwused{\\{NW1Nnu7l-WRyHP-1}}\nwidentuses{\\{{\nwixident{Lm3}}{Lm3}}\\{{\nwixident{Lm6}}{Lm6}}}\nwindexuse{\nwixident{Lm3}}{Lm3}{NW1Nnu7l-kMqjk-1}\nwindexuse{\nwixident{Lm6}}{Lm6}{NW1Nnu7l-kMqjk-1}\nwendcode{}\nwbegindocs{42}\nwdocspar
...
\nwused{\\{NW1Nnu7l-32pmQO-1}}\nwidentdefs{\\{{\nwixident{Th8}}{Th8}}}\nwidentuses{\\{{\nwixident{Lm17}}{Lm17}}}\nwindexuse{\nwixident{Lm17}}{Lm17}{NW1Nnu7l-3WScXE-1}\nwendcode{}\nwbegindocs{46}\nwdocspar
\begin{theorem}
...
\nwused{\\{NW1Nnu7l-39h8sj-1}}\nwidentuses{\\{{\nwixident{Lm7}}{Lm7}}}\nwindexuse{\nwixident{Lm7}}{Lm7}{NW1Nnu7l-476s7N-1}\nwendcode{}\nwbegindocs{74}\nwdocspar
...
\nwixlogsorted{c}{{Lemma: $H\subgroup G$, $H$ is trivial implies $H=\trivialSubgroup_{G}$}{NW18nMBU-3k2d9L-1}{\nwixu{NW18nMBU-oqDk7-1}\nwixd{NW18nMBU-3k2d9L-1}}}%
...
\nwused{\\{NW47t2dy-1dPqXM-1}}\nwidentuses{\\{{\nwixident{Lm6}}{Lm6}}}\nwindexuse{\nwixident{Lm6}}{Lm6}{NW47t2dy-3ZyLrF-1}\nwendcode{}\nwbegindocs{54}\nwdocspar
