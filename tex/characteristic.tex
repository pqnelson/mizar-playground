...
proof
  ...
  then A2: \LA{}Defining formulas for $\rng(f)$ and $f(X)$~{\nwtagstyle{}\subpageref{NW18nMBU-24g6aa-1}}\RA{};
...
\begin{lemma}[{Restriction of Group Morphisms to Subgroups}]
...
follows that $g = \varphi(\varphi^{-1}(b))$, and by {\Tt{}\nwlinkedidentq{Lm11}{NW18nMBU-1Brdpy-1}\nwendquote} we have
...
\begin{proof}[Proof sketch]
The argument basically applies {\Tt{}\nwlinkedidentq{Th7}{NW1Nnu7l-xUcSR-1}\nwendquote} to $\varphi^{-1}$, then unfolds
definitions.
\end{proof}
...
injective by {\Tt{}\nwlinkedidentq{Lm9}{NW1Nnu7l-2Beici-1}\nwendquote}. This gives us our result.
\end{proof}
...
\begin{proof}[Proof outline]
  ...
  Our next claim $C_{2}$ is that $\varphi|_{H}$ is injective by {\Tt{}\nwlinkedidentq{Lm9}{NW1Nnu7l-2Beici-1}\nwendquote}
  and hypothesis $A_{1}$.
...
\begin{remark}[Notation: $\Inn(G)$]\index{$\Inn(G)$}
...
\begin{definition}\index{Automorphism!outer}
...
\begin{theorem}[Kernel of inner automorphism is trivial]
...
(thanks to {\Tt{}\nwlinkedidentq{Th16}{NW3Mfp8C-3fLhao-1}\nwendquote} and theorem {\Tt{}GROUP{\_}6:56\nwendquote}\MizThm{GROUP\_6}{56}).
...
\begin{proof}
We have shown in {\Tt{}\nwlinkedidentq{Th17}{NW3Mfp8C-VBRVv-1}\nwendquote} that conjugation is an automorphism, and by
...
thanks to {\Tt{}\nwlinkedidentq{Th18}{NW3Mfp8C-47V7KL-1}\nwendquote}.
\end{proof}
...
$\varphi(H) = H^{a}$ by {\Tt{}\nwlinkedidentq{Th15}{NW3Mfp8C-2zspfg-1}\nwendquote} and $H^{a}=H$ by definition
...
\begin{remark}[Proof by contradiction in Mizar]\index{Proof!by Contradiction}
...
$\varphi(H)\subgroup H$. We prove this later as equivalent (\S\ref{thm:results:alt-def-of-char-subgroup}).
\end{remark}
...
therefore a normal subgroup of $G$ by {\Tt{}\nwlinkedidentq{LmNormalSubgroup}{NW18nMBU-3PXqHm-1}\nwendquote}.
\end{proof}
...
by {\Tt{}\nwlinkedidentq{Th20}{NW3Mfp8C-4Qqcti-1}\nwendquote} which implies $\varphi|_{N}\in\Aut(N)$ by {\Tt{}\nwlinkedidentq{Th11}{NW1Nnu7l-1QHEJY-1}\nwendquote}. Viewed
...
proof
  ...
  A2: for phi being \nwlinkedidentc{Automorphism}{NW1Nnu7l-4WeeL5-1} of G holds H is Subgroup of Image(phi|H)
  \LA{}Proof: $\forall\varphi\in\Aut(G),H\subgroup\varphi(H)$~{\nwtagstyle{}\subpageref{NW47t2dy-2AHwGO-1}}\RA{}
  for phi being \nwlinkedidentc{Automorphism}{NW1Nnu7l-4WeeL5-1} of G holds H = Image(phi|H)
  proof
    let phi be \nwlinkedidentc{Automorphism}{NW1Nnu7l-4WeeL5-1} of G;
...
\item[{{\Tt{}\nwlinkedidentq{Th6}{NW1Nnu7l-g7029-1}\nwendquote}}:] for $\psi=\varphi^{-1}$, we have $\varphi[\psi(H)]\subgroup\varphi(H)$; and
\item[{{\Tt{}\nwlinkedidentq{Th7}{NW1Nnu7l-xUcSR-1}\nwendquote}}:] for $\psi=\varphi^{-1}$, the underlying magmas of $H$ and $\varphi[\psi(H)]$ are equal.
\end{itemize}
This suffices to infer $H\subgroup\varphi(H)$.
\end{proof}

\nwenddocs{}\nwbegincode{45}\sublabel{NW47t2dy-2AHwGO-1}\nwmargintag{{\nwtagstyle{}\subpageref{NW47t2dy-2AHwGO-1}}}\moddef{Proof: $\forall\varphi\in\Aut(G),H\subgroup\varphi(H)$~{\nwtagstyle{}\subpageref{NW47t2dy-2AHwGO-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NW47t2dy-1WVJgD-1}}\nwenddeflinemarkup
proof
  let phi be \nwlinkedidentc{Automorphism}{NW1Nnu7l-4WeeL5-1} of G;
  consider psi being \nwlinkedidentc{Automorphism}{NW1Nnu7l-4WeeL5-1} of G such that
  B1: psi = phi" and
