...
A3: for phi being \nwlinkedidentc{Automorphism}{NW1Nnu7l-4WeeL5-1} of G
  ...
  proof
    ...
    consider psi being \nwlinkedidentc{Automorphism}{NW1Nnu7l-4WeeL5-1} of G such that
    AA1: psi = phi" and
    B1: Image(phi|Image(psi|Z)) is Subgroup of Image(phi|Z) by A3,\nwlinkedidentc{Lm39}{NW47t2dy-2FnGSI-1};
    consider psi2 being \nwlinkedidentc{Automorphism}{NW1Nnu7l-4WeeL5-1} of G such that
    AA2: psi2 = phi" and
    B2: the multMagma of Z = the multMagma of Image(phi|Image(psi2|Z)) by A3,\nwlinkedidentc{Lm40}{NW47t2dy-1FL4YM-1};
    psi2 = psi by AA1,AA2;
