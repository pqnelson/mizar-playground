...
proof
  ...
  proof
    ...
    proof
      ...
      then d*card(N "\\/" K) = m*(d*q) by A2,B1,B21,\nwlinkedidentc{Th70}{NW4XxNUZ-2r8YQx-1}
                           .= m*d*q
                           .= d*m*q
                           .= d*(m*q);
      hence card(N "\\/" K) = m*q by XCMPLX_1:5;
    end;
    B5: q divides n by A2,A4,B3,\nwlinkedidentc{Th67}{NW4XxNUZ-2glx4T-1},GROUP_2:148;
    q=1 by A1,A2,A3,B21,B22,B5,\nwlinkedidentc{Th68}{NW4XxNUZ-2iwTOx-1};
    hence Image(phi|N) = N by A2,B1,B21,\nwlinkedidentc{Th66}{NW4XxNUZ-1Is6lQ-1};
  end;
...
proof
  ...
  proof
    ...
    consider b being Element of G such that
    B3: x = b*N & sigma.x = (phi.b)*N by A3;
    consider n being Element of G such that
    B7: n = b" * a & n in N by B2,B3,GROUP_2:114;
  ...
  proof
    ...
    proof
      ...
      proof
        ...
        then Z4: psi * phi = id the carrier of G by Z3,FUNCT_2:29;
        dom psi = the carrier of G by FUNCT_2:def 1;
        then psi.(phi.x) in psi .: (the carrier of (phi .: N)) by Z2,FUNCT_1:def 6;
        then psi.(phi.x) in the carrier of (psi .: (phi .: N)) by GRSOLV_1:8;
        then x in i .: N by B3,Z3,Z4,\nwlinkedidentc{Th72}{NW4XxNUZ-2e3eIH-1};
        then Z5: x in (id the carrier of G) .: (the carrier of N) by GRSOLV_1:8;
        the carrier of N is Subset of the carrier of G by GROUP_2:def 5;
        hence x in N by Z5,FUNCT_1:92;
      end;
      thus x in N implies x*N in Ker sigma
      proof
        assume x in N;
        then Z1: x * N = carr N by GROUP_2:113
                      .= 1_(G./.N) by GROUP_6:24;
        then sigma.(x*N) = 1_(G./.N) by GROUP_6:31;
        hence x*N in Ker sigma by Z1,GROUP_6:41;
      end;
    end;
    ...
    proof
      ...
      proof
        ...
        g*N = carr N by BB1,Z1,Z2,GROUP_2:113;
        then g*N = 1_(G./.N) by GROUP_6:24;
        then g*N in \{1_(G./.N)\} by TARSKI:def 1;
        hence x in (1).(G./.N) by Z2,GROUP_2:def 7;
      end;
...
proof
  ...
  proof
    ...
    proof
      assume C1: k in H;
      C2: g in K;
      (nat_hom H).g = 1_(G./.H) by A3,C1,GROUP_6:41;
  ...
  the multMagma of R = the multMagma of H1 by A4,GROUP_2:60;
  hence thesis;
end;
...
proof
  ...
  proof
    ...
    proof
      ...
      C6: x = a*(K,H)`*` by B3,C1,C3,GROUP_2:def 15;
      ...
      proof
        ...
        proof
          ...
          Z1: j1 = a*g1 & g1 in (K,H)`*` by GROUP_2:103;
          reconsider g=g1 as Element of G by GROUP_2:42;
          Z2: j1 = a1*g by Z1,GROUP_2:43;
          g in H by Z1,A1,GROUP_6:def 1;
          hence j1 in a1*H by Z2,GROUP_2:103;
        end;
        ...
        proof
          ...
          Z1: j1 = a1*g1 & g1 in H by GROUP_2:103;
          reconsider g=g1 as Element of K by A1,Z1,GROUP_2:42;
          Z2: j1 = a*g by Z1,GROUP_2:43;
          g in (K,H)`*` by Z1,A1, GROUP_6:def 1;
          hence j1 in a*(K,H)`*` by Z2,GROUP_2:103;
        end;

      end;
      then a1*H = x by TARSKI:2,C6
               .= k1*H by C3;
      then (a1") * k1 in H by GROUP_2:114;
      then C8: (a1") * k1 in K by A1,GROUP_2:41;
      a1 * ((a1") * k1) = (a1 * a1") * k1 by GROUP_1:def 3
                       .= 1_G * k1 by GROUP_1:def 5
                       .= k1 by GROUP_1:def 4;
      hence k1 in K by C7,C8,GROUP_2:50;
    end;

    B6: for k1 being Element of G holds k1 in K iff k1*H in J
    proof
      let k1 be Element of G;
      ...
      proof
        ...
        proof
          ...
          proof
            ...
            Z3: huh in H by A1,Z2,GROUP_6:def 1;
          ...
          Z2: x = k1*h1 & h1 in carr(H) by GROUP_2:27;
          reconsider h2=h1 as Element of K by A1,Z2,GROUP_2:42;
          reconsider H1=H as normal Subgroup of K by A3;
          Z3: the carrier of H = the carrier of ((K,H)`*`) by A1,GROUP_6:def 1;
          k2*h2 in k2*carr(H1) by Z2,GROUP_2:27;
          hence x in k2*carr((K,H)`*`) by Z2,Z3,GROUP_2:43;
        end;
    ...
    sigma.(kH) in J by \nwlinkedidentc{Th50}{NW47t2dy-2u8tjJ-1},B1,B6;
    then sigma.(k*H) in J & sigma.(k*H) = (phi.k)*H by B2;
    hence phi.k in K by B5;
  end;
...
proof
  ...
  proof
    ...
    B3: n2 = g * n * g";
    B4: n2 = n |^ g" by B3;
    then (x * n2) |^ g = (n2 * x) |^ g by B1,B2,A2,\nwlinkedidentc{Th60}{NW4XxNUZ-3TgHH7-1}
  ...
  proof
    ...
    proof
      ...
      assume z in (\nwlinkedidentc{Centralizer}{NW4XxNUZ-1mdlmG-1} N);
      then (z |^ g") |^ g in (\nwlinkedidentc{Centralizer}{NW4XxNUZ-1mdlmG-1} N) |^ g by A4,GROUP_3:58;
  ...
  proof
    ...
    proof
      ...
      proof
        let z be Element of N;
        assume z in Z;
        then (z |^ n") |^ n in (Z |^ n) by B5,GROUP_3:58;
...
proof
  ...
  proof
    ...
    then consider g being Element of G such that
    Z1: g in H & g*z1 <> z1 * g by \nwlinkedidentc{Th60}{NW4XxNUZ-3TgHH7-1};
    H is Subgroup of Normalizer H by \nwlinkedidentc{Th80}{NW4XxNUZ-40hsCt-1};
    then g in Normalizer H by Z1, GROUP_2:41;
    then reconsider n=g as Element of N;
    Z2: g*z1 = n*z by GROUP_2:43;
    take n;
    thus thesis by Z1,Z2,GROUP_2:43;
  end;
  hence
