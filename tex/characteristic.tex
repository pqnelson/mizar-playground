...
MSSUBFAM, RELAT_1, TARSKI, FUNCT_1, ZFMISC_1, ARYTM_3, ARYTM_2,
...
for X,Y being \nwlinkedidentc{non}{NW18nMBU-47kVo6-1} empty set
...
\emph{overloaded}) in \verb#GROUP_6:def 2#\MizDef{GROUP\_6}[02]{2}:
...
\begin{proposition}[{\texttt{GROUP\_1:3}\MizThm{GROUP\_1}[03]{3}}]
...
proof
  let H be Subgroup of G;
  assume A1: H is \nwlinkedidentc{proper}{NW18nMBU-RKCxZ-1} Subgroup of G;
  then (the carrier of G) \\ (the carrier of H) is \nwlinkedidentc{non}{NW18nMBU-47kVo6-1} empty by \nwlinkedidentc{Lm100}{NW18nMBU-2cWeD5-1};
  then consider x being object such that
...
proof
  ...
  set UH = the carrier of H;
  set UG = the carrier of G;
  A1: phi is one-to-one & phi is onto & UH is \nwlinkedidentc{non}{NW18nMBU-47kVo6-1} empty Subset of UG &
...
(i.e., \verb#FUNCT_1:def 3#\MizDef{FUNCT\_1}[03]{3}). Since $\varphi$ is
