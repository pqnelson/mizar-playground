...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Proper Subgroups}\index{Subgroup!Proper}
...
exists amounts to reconsidering {\Tt{}id\nwendquote} as an endomorphism. Using Theorem~\cite[Th17]{funct1}\MizThm{FUNCT\_1}{17} the identity
...
proof
  ...
  proof
    ...
    K is non \nwlinkedidentc{trivial}{NW18nMBU-47kVo6-1} Subgroup of G by A3,B1,B2,\nwlinkedidentc{Lm110}{NW18nMBU-1gsRKB-1};
    then reconsider K as non \nwlinkedidentc{trivial}{NW18nMBU-47kVo6-1} strict Subgroup of G;

    B5: Image(phi|H) is \nwlinkedidentc{proper}{NW18nMBU-RKCxZ-1} Subgroup of K by B1,B2,\nwlinkedidentc{Def10}{NW18nMBU-RKCxZ-1};
    then (the carrier of K) \\ (the carrier of Image(phi|H)) is non empty
    by \nwlinkedidentc{Lm100}{NW18nMBU-2cWeD5-1};
    then consider k being object such that
    B6: k in (the carrier of K) \\ (the carrier of Image(phi|H))
    by XBOOLE_0:def 1;
    ...
    proof
      ...
      phi is Function of UG,UG by GROUP_2:def 5;
      C2: k in G & not k in Image(phi|H) by B7, GROUP_2:41;
      then C3: not psi.k in (psi .: UPH)
      by C1,\nwlinkedidentc{Lm18}{NW18nMBU-41PUYF-1};
      consider phi2 being \nwlinkedidentc{Automorphism}{NW1Nnu7l-4WeeL5-1} of G such that
      C4: phi2 = psi" and
      C5: the multMagma of Image(psi|Image(phi2|H)) = the multMagma of H
      by \nwlinkedidentc{Th7}{NW1Nnu7l-xUcSR-1};
      phi2=phi by C4,B3, \nwlinkedidentc{Lm10}{NW18nMBU-34x7vU-1};
      then C6: the multMagma of Image(psi|Image(phi|H)) = the multMagma of H by C5;
      psi .: (the carrier of Image(phi|H))
      = the carrier of (psi .: Image(phi|H)) by GRSOLV_1:8
      .= the carrier of Image(psi|Image(phi|H)) by GRSOLV_1:def 3;
      then not psi.k in H by C3,C6;
      then the carrier of H <> the carrier of L by B8;
      hence thesis;
    end;
    then B10: L = the multMagma of G by A1,B4,GROUP_4:def 6;
    ...
    then B11: Image(phi|L) = the multMagma of G;
    Image(phi|L) = K
    proof
...
\begin{thm-remark}
Mizar has~\cite{autgroup}, an article which defines {\Tt{}Aut\ G\nwendquote} the
