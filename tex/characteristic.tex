...
proof
  ...
  \LA{}Proof: $y\in\rng(f)\implies y\in f(X)$~{\nwtagstyle{}\subpageref{NW18nMBU-1hpzfw-1}}\RA{}
...
\nwenddocs{}\nwbegincode{9}\sublabel{NW18nMBU-1hpzfw-1}\nwmargintag{{\nwtagstyle{}\subpageref{NW18nMBU-1hpzfw-1}}}\moddef{Proof: $y\in\rng(f)\implies y\in f(X)$~{\nwtagstyle{}\subpageref{NW18nMBU-1hpzfw-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NW18nMBU-3LADMa-1}}\nwenddeflinemarkup
proof
  let y be object;
  assume y in rng f;
  then consider x being object such that
...
\nwixlogsorted{c}{{Proof: $y\in\rng(f)\implies y\in f(X)$}{NW18nMBU-1hpzfw-1}{\nwixu{NW18nMBU-3LADMa-1}\nwixd{NW18nMBU-1hpzfw-1}}}%
