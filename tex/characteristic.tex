...
Theorem~38\MizThm{GROUP\_6}{38} (which effectively states the function on the underlying set
...
in {\Tt{}FUNCT{\_}1\nwendquote} proved (in Theorem~17\MizThm{FUNCT\_1}{17}) the identity
...
\nwenddocs{}\nwbegincode{39}\sublabel{NW47t2dy-4Z20G4-1}\nwmargintag{{\nwtagstyle{}\subpageref{NW47t2dy-4Z20G4-1}}}\moddef{Theorem: $H\subgroup G$ is characteristic iff $\forall\varphi\in\Aut(G),\varphi(H)\subgroup H$~{\nwtagstyle{}\subpageref{NW47t2dy-4Z20G4-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NW47t2dy-3N17ED-1}}\nwenddeflinemarkup
\LA{}Lemma: $(\forall\varphi\in\Aut(G),\varphi(H)\subgroup H)\implies\varphi[\varphi^{-1}(H)]\subgroup G$~{\nwtagstyle{}\subpageref{NW47t2dy-2FnGSI-1}}\RA{}
\LA{}Lemma: $(\forall\varphi\in\Aut(G),\varphi(H)\subgroup H)\implies \varphi[\varphi^{-1}(H)]=H$~{\nwtagstyle{}\subpageref{NW47t2dy-1FL4YM-1}}\RA{}

theorem \nwlinkedidentc{Th27}{NW47t2dy-4Z20G4-1}:
  for H being strict Subgroup of G
  holds H is \nwlinkedidentc{characteristic}{NW47t2dy-49dosn-1} Subgroup of G iff
  (for phi being \nwlinkedidentc{Automorphism}{NW1Nnu7l-4WeeL5-1} of G holds Image(phi|H) is Subgroup of H)
proof
  let H be strict Subgroup of G;
...
\nwused{\\{NW47t2dy-4Z20G4-1}}\nwidentuses{\\{{\nwixident{Automorphism}}{Automorphism}}\\{{\nwixident{characteristic}}{characteristic}}\\{{\nwixident{Def9}}{Def9}}\\{{\nwixident{Lm39}}{Lm39}}\\{{\nwixident{Lm40}}{Lm40}}}\nwindexuse{\nwixident{Automorphism}}{Automorphism}{NW47t2dy-1WVJgD-1}\nwindexuse{\nwixident{characteristic}}{characteristic}{NW47t2dy-1WVJgD-1}\nwindexuse{\nwixident{Def9}}{Def9}{NW47t2dy-1WVJgD-1}\nwindexuse{\nwixident{Lm39}}{Lm39}{NW47t2dy-1WVJgD-1}\nwindexuse{\nwixident{Lm40}}{Lm40}{NW47t2dy-1WVJgD-1}\nwendcode{}\nwbegindocs{44}\nwdocspar

\nwenddocs{}\nwbegincode{45}\sublabel{NW47t2dy-2FnGSI-1}\nwmargintag{{\nwtagstyle{}\subpageref{NW47t2dy-2FnGSI-1}}}\moddef{Lemma: $(\forall\varphi\in\Aut(G),\varphi(H)\subgroup H)\implies\varphi[\varphi^{-1}(H)]\subgroup G$~{\nwtagstyle{}\subpageref{NW47t2dy-2FnGSI-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NW47t2dy-4Z20G4-1}}\nwenddeflinemarkup
\nwlinkedidentc{Lm39}{NW47t2dy-2FnGSI-1}:
for H being Subgroup of G
...
\nwindexdefn{\nwixident{Lm39}}{Lm39}{NW47t2dy-2FnGSI-1}\eatline
\nwused{\\{NW47t2dy-4Z20G4-1}}\nwidentdefs{\\{{\nwixident{Lm39}}{Lm39}}}\nwidentuses{\\{{\nwixident{Automorphism}}{Automorphism}}}\nwindexuse{\nwixident{Automorphism}}{Automorphism}{NW47t2dy-2FnGSI-1}\nwendcode{}\nwbegindocs{46}\nwdocspar
\nwenddocs{}\nwbegincode{47}\sublabel{NW47t2dy-1FL4YM-1}\nwmargintag{{\nwtagstyle{}\subpageref{NW47t2dy-1FL4YM-1}}}\moddef{Lemma: $(\forall\varphi\in\Aut(G),\varphi(H)\subgroup H)\implies \varphi[\varphi^{-1}(H)]=H$~{\nwtagstyle{}\subpageref{NW47t2dy-1FL4YM-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NW47t2dy-4Z20G4-1}}\nwenddeflinemarkup
\nwlinkedidentc{Lm40}{NW47t2dy-1FL4YM-1}:
for H being Subgroup of G
st (for f being \nwlinkedidentc{Automorphism}{NW1Nnu7l-4WeeL5-1} of G holds Image(f|H) is Subgroup of H)
for phi being \nwlinkedidentc{Automorphism}{NW1Nnu7l-4WeeL5-1} of G
...
proof
  ...
  \LA{}Proof: $\forall g\in G$, $g\in\varphi[\varphi^{-1}(H)]\iff g\in H$~{\nwtagstyle{}\subpageref{NW47t2dy-1ZaFZM-1}}\RA{}
  hence the multMagma of Image(phi|Image(psi|H)) = the multMagma of H by GROUP_2:60;
end;

\nwindexdefn{\nwixident{Lm40}}{Lm40}{NW47t2dy-1FL4YM-1}\eatline
\nwused{\\{NW47t2dy-4Z20G4-1}}\nwidentdefs{\\{{\nwixident{Lm40}}{Lm40}}}\nwidentuses{\\{{\nwixident{Automorphism}}{Automorphism}}}\nwindexuse{\nwixident{Automorphism}}{Automorphism}{NW47t2dy-1FL4YM-1}\nwendcode{}\nwbegindocs{48}\nwdocspar
\M The bones of the proof for this claim amounts to unfolding the
logical structure of the claim.

\nwenddocs{}\nwbegincode{49}\sublabel{NW47t2dy-1ZaFZM-1}\nwmargintag{{\nwtagstyle{}\subpageref{NW47t2dy-1ZaFZM-1}}}\moddef{Proof: $\forall g\in G$, $g\in\varphi[\varphi^{-1}(H)]\iff g\in H$~{\nwtagstyle{}\subpageref{NW47t2dy-1ZaFZM-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NW47t2dy-1FL4YM-1}}\nwenddeflinemarkup
proof
  let g be Element of G;
  thus g in Image(phi|Image(psi|H)) implies g in H
  \LA{}Step 1: $g\in\varphi[\varphi^{-1}(H)]\implies g\in H$~{\nwtagstyle{}\subpageref{NW47t2dy-47FJLD-1}}\RA{}

  thus g in H implies g in Image(phi|Image(psi|H))
  \LA{}Step 2: $g\in\varphi[\varphi^{-1}(H)]\impliedby g\in H$~{\nwtagstyle{}\subpageref{NW47t2dy-WRyHP-1}}\RA{}
  thus thesis;
end;

\nwused{\\{NW47t2dy-1FL4YM-1}}\nwendcode{}\nwbegindocs{50}\nwdocspar

\nwenddocs{}\nwbegincode{51}\sublabel{NW47t2dy-47FJLD-1}\nwmargintag{{\nwtagstyle{}\subpageref{NW47t2dy-47FJLD-1}}}\moddef{Step 1: $g\in\varphi[\varphi^{-1}(H)]\implies g\in H$~{\nwtagstyle{}\subpageref{NW47t2dy-47FJLD-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NW47t2dy-1ZaFZM-1}}\nwenddeflinemarkup
proof
  ...
  B2: g = (phi|Image(psi|H)).a by GROUP_6:45;
  B3: a in Image(psi|H) & a is Element of G by STRUCT_0:def 5,GROUP_2:42;
  then B4: phi.a = (phi|Image(psi|H)).a by \nwlinkedidentc{Lm3}{NW18nMBU-3Uc8Un-1}
                .= g by B2;
  consider b being Element of H such that
  B5: a = (psi|H).b
  by B3,GROUP_6:45;
  B6: b in H & b is Element of G by STRUCT_0:def 5, GROUP_2:42;
  then psi.b = (psi|H).b by \nwlinkedidentc{Lm3}{NW18nMBU-3Uc8Un-1}
            .= a by B5;
  then B7: phi.(psi.b) = phi.a
                      .= g by B4;
...
\nwused{\\{NW47t2dy-1ZaFZM-1}}\nwidentuses{\\{{\nwixident{Lm11}}{Lm11}}\\{{\nwixident{Lm3}}{Lm3}}}\nwindexuse{\nwixident{Lm11}}{Lm11}{NW47t2dy-47FJLD-1}\nwindexuse{\nwixident{Lm3}}{Lm3}{NW47t2dy-47FJLD-1}\nwendcode{}\nwbegindocs{52}\nwdocspar

\M To prove $g\in H$ implies $g\in\varphi[\varphi^{-1}(H)]$, we simply
...
\nwenddocs{}\nwbegincode{53}\sublabel{NW47t2dy-WRyHP-1}\nwmargintag{{\nwtagstyle{}\subpageref{NW47t2dy-WRyHP-1}}}\moddef{Step 2: $g\in\varphi[\varphi^{-1}(H)]\impliedby g\in H$~{\nwtagstyle{}\subpageref{NW47t2dy-WRyHP-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NW47t2dy-1ZaFZM-1}}\nwenddeflinemarkup
proof
  assume B1: g in H;
  set a = (psi|H).g;
  B2: a in Image(psi|H)
  \LA{}Sub-step 1: $a\in\varphi^{-1}(H)$~{\nwtagstyle{}\subpageref{NW47t2dy-3vZPH1-1}}\RA{}

  set K = Image(psi|H);
  set b = (phi|Image(psi|H)).a;

  B3: b in Image(phi|Image(psi|H))
  \LA{}Sub-step 2: $b\in\varphi[\varphi^{-1}(H)]$~{\nwtagstyle{}\subpageref{NW47t2dy-2IWBBW-1}}\RA{}
  thus g in Image(phi|K)
  \LA{}Sub-step 3: $g\in\varphi[\varphi^{-1}(H)]$~{\nwtagstyle{}\subpageref{NW47t2dy-kMqjk-1}}\RA{}
end;

\nwused{\\{NW47t2dy-1ZaFZM-1}}\nwendcode{}\nwbegindocs{54}\nwdocspar

\M The first step follows by unfolding definitions.

\nwenddocs{}\nwbegincode{55}\sublabel{NW47t2dy-3vZPH1-1}\nwmargintag{{\nwtagstyle{}\subpageref{NW47t2dy-3vZPH1-1}}}\moddef{Sub-step 1: $a\in\varphi^{-1}(H)$~{\nwtagstyle{}\subpageref{NW47t2dy-3vZPH1-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NW47t2dy-WRyHP-1}}\nwenddeflinemarkup
proof
...
\nwused{\\{NW47t2dy-WRyHP-1}}\nwendcode{}\nwbegindocs{56}\nwdocspar

\M The next step, like the first, follows from definitions.

\nwenddocs{}\nwbegincode{57}\sublabel{NW47t2dy-2IWBBW-1}\nwmargintag{{\nwtagstyle{}\subpageref{NW47t2dy-2IWBBW-1}}}\moddef{Sub-step 2: $b\in\varphi[\varphi^{-1}(H)]$~{\nwtagstyle{}\subpageref{NW47t2dy-2IWBBW-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NW47t2dy-WRyHP-1}}\nwenddeflinemarkup
proof
...
\M The last step is a little more involved, because it requires
...
\nwenddocs{}\nwbegincode{59}\sublabel{NW47t2dy-kMqjk-1}\nwmargintag{{\nwtagstyle{}\subpageref{NW47t2dy-kMqjk-1}}}\moddef{Sub-step 3: $g\in\varphi[\varphi^{-1}(H)]$~{\nwtagstyle{}\subpageref{NW47t2dy-kMqjk-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NW47t2dy-WRyHP-1}}\nwenddeflinemarkup
proof
...
\nwused{\\{NW47t2dy-WRyHP-1}}\nwidentuses{\\{{\nwixident{Lm11}}{Lm11}}\\{{\nwixident{Lm3}}{Lm3}}}\nwindexuse{\nwixident{Lm11}}{Lm11}{NW47t2dy-kMqjk-1}\nwindexuse{\nwixident{Lm3}}{Lm3}{NW47t2dy-kMqjk-1}\nwendcode{}\nwbegindocs{60}\nwdocspar
...
\M The heart of the proof amounts to showing, for any Automorphism
$\varphi$, that $\varphi(Z(G))$ is a subgroup of $Z(G)$.

\nwenddocs{}\nwbegincode{63}\sublabel{NW47t2dy-1dPqXM-1}\nwmargintag{{\nwtagstyle{}\subpageref{NW47t2dy-1dPqXM-1}}}\moddef{Prove $\forall\varphi\in\Aut(G),\varphi(Z(G))\subgroup Z(G)$~{\nwtagstyle{}\subpageref{NW47t2dy-1dPqXM-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NW47t2dy-g56Nl-1}}\nwenddeflinemarkup
A1: for phi being \nwlinkedidentc{Automorphism}{NW1Nnu7l-4WeeL5-1} of G
for y,z being Element of G
st z in Z
holds (phi.z)*y = y*phi.z
\LA{}Proof: $\forall y\in G\forall z\in Z(G), \varphi(z)y = y\varphi(z)$~{\nwtagstyle{}\subpageref{nw@notdef}}\RA{}

A2: for phi being \nwlinkedidentc{Automorphism}{NW1Nnu7l-4WeeL5-1} of G
for z being Element of G
st z in Z
holds (phi|Z).z in Z
\LA{}Proof: $\forall\varphi\in\Aut(G)\forall z\in G, z\in Z(G)\implies \varphi(z)\in Z(G)$~{\nwtagstyle{}\subpageref{NW47t2dy-1r6XYV-1}}\RA{}

A3: for phi being \nwlinkedidentc{Automorphism}{NW1Nnu7l-4WeeL5-1} of G
holds Image(phi|Z) is Subgroup of Z
\LA{}Proof: $\forall\varphi\in\Aut(G),\varphi(Z(G))\subgroup Z(G)$~{\nwtagstyle{}\subpageref{NW47t2dy-4DR8cg-1}}\RA{}

\nwused{\\{NW47t2dy-g56Nl-1}}\nwidentuses{\\{{\nwixident{Automorphism}}{Automorphism}}}\nwindexuse{\nwixident{Automorphism}}{Automorphism}{NW47t2dy-1dPqXM-1}\nwendcode{}\nwbegindocs{64}\nwdocspar

\M Proving $\varphi(z)$ commutes with every element of the group is a
straightforward calculation. In fact, this is usually what textbooks
present, then dismiss the rest of the proof as ``trivial'' or ``obvious''.

\nwenddocs{}\nwbegincode{65}\sublabel{NW47t2dy-2bW9jm-1}\nwmargintag{{\nwtagstyle{}\subpageref{NW47t2dy-2bW9jm-1}}}\moddef{Proof: $\forall\varphi\in\Aut(G)\forall y\in G\forall z\in Z(G), \varphi(z)y = y\varphi(z)$~{\nwtagstyle{}\subpageref{NW47t2dy-2bW9jm-1}}}\endmoddef\nwstartdeflinemarkup\nwenddeflinemarkup
proof
  let phi be \nwlinkedidentc{Automorphism}{NW1Nnu7l-4WeeL5-1} of G;
...
\nwnotused{Proof: $\forall\varphi\in\Aut(G)\forall y\in G\forall z\in Z(G), \varphi(z)y = y\varphi(z)$}\nwidentuses{\\{{\nwixident{Automorphism}}{Automorphism}}\\{{\nwixident{Lm11}}{Lm11}}}\nwindexuse{\nwixident{Automorphism}}{Automorphism}{NW47t2dy-2bW9jm-1}\nwindexuse{\nwixident{Lm11}}{Lm11}{NW47t2dy-2bW9jm-1}\nwendcode{}\nwbegindocs{66}\nwdocspar

\M Establishing $z\in Z(G)$ implies $\varphi(z)\in Z(G)$ amounts to
unfolding definitions.

\nwenddocs{}\nwbegincode{67}\sublabel{NW47t2dy-1r6XYV-1}\nwmargintag{{\nwtagstyle{}\subpageref{NW47t2dy-1r6XYV-1}}}\moddef{Proof: $\forall\varphi\in\Aut(G)\forall z\in G, z\in Z(G)\implies \varphi(z)\in Z(G)$~{\nwtagstyle{}\subpageref{NW47t2dy-1r6XYV-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NW47t2dy-1dPqXM-1}}\nwenddeflinemarkup
proof
  let phi be \nwlinkedidentc{Automorphism}{NW1Nnu7l-4WeeL5-1} of G;
...
\nwused{\\{NW47t2dy-1dPqXM-1}}\nwidentuses{\\{{\nwixident{Automorphism}}{Automorphism}}\\{{\nwixident{Lm3}}{Lm3}}}\nwindexuse{\nwixident{Automorphism}}{Automorphism}{NW47t2dy-1r6XYV-1}\nwindexuse{\nwixident{Lm3}}{Lm3}{NW47t2dy-1r6XYV-1}\nwendcode{}\nwbegindocs{68}\nwdocspar

\M The last step, which is the ``obvious'' part, infers from
$\forall z\in Z(G),\varphi(z)\in Z(G)$ that $\varphi(Z(G))\subgroup Z(G)$.


\nwenddocs{}\nwbegincode{69}\sublabel{NW47t2dy-4DR8cg-1}\nwmargintag{{\nwtagstyle{}\subpageref{NW47t2dy-4DR8cg-1}}}\moddef{Proof: $\forall\varphi\in\Aut(G),\varphi(Z(G))\subgroup Z(G)$~{\nwtagstyle{}\subpageref{NW47t2dy-4DR8cg-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NW47t2dy-1dPqXM-1}}\nwenddeflinemarkup
proof
  let phi be \nwlinkedidentc{Automorphism}{NW1Nnu7l-4WeeL5-1} of G;
  B1: rng(phi|Z) c= the carrier of G &
  ...
  proof
    ...
    C3: z in Z by STRUCT_0:def 5;
    z is Element of G by GROUP_2:42;
    then (phi|Z).z in Z by A2,C3;
    hence w in Z by C2;
  end;
...
\nwused{\\{NW47t2dy-1dPqXM-1}}\nwidentuses{\\{{\nwixident{Automorphism}}{Automorphism}}}\nwindexuse{\nwixident{Automorphism}}{Automorphism}{NW47t2dy-4DR8cg-1}\nwendcode{}
...
\nwixlogsorted{c}{{Lemma: $(\forall\varphi\in\Aut(G),\varphi(H)\subgroup H)\implies \varphi[\varphi^{-1}(H)]=H$}{NW47t2dy-1FL4YM-1}{\nwixu{NW47t2dy-4Z20G4-1}\nwixd{NW47t2dy-1FL4YM-1}}}%
\nwixlogsorted{c}{{Lemma: $(\forall\varphi\in\Aut(G),\varphi(H)\subgroup H)\implies\varphi[\varphi^{-1}(H)]\subgroup G$}{NW47t2dy-2FnGSI-1}{\nwixu{NW47t2dy-4Z20G4-1}\nwixd{NW47t2dy-2FnGSI-1}}}%
...
\nwixlogsorted{c}{{Proof: $\forall g\in G$, $g\in\varphi[\varphi^{-1}(H)]\iff g\in H$}{NW47t2dy-1ZaFZM-1}{\nwixu{NW47t2dy-1FL4YM-1}\nwixd{NW47t2dy-1ZaFZM-1}}}%
...
\nwixlogsorted{c}{{Proof: $\forall y\in G\forall z\in Z(G), \varphi(z)y = y\varphi(z)$}{nw@notdef}{\nwixu{NW47t2dy-1dPqXM-1}}}%
\nwixlogsorted{c}{{Proof: $\forall\varphi\in\Aut(G),\varphi(Z(G))\subgroup Z(G)$}{NW47t2dy-4DR8cg-1}{\nwixu{NW47t2dy-1dPqXM-1}\nwixd{NW47t2dy-4DR8cg-1}}}%
\nwixlogsorted{c}{{Proof: $\forall\varphi\in\Aut(G)\forall y\in G\forall z\in Z(G), \varphi(z)y = y\varphi(z)$}{NW47t2dy-2bW9jm-1}{\nwixd{NW47t2dy-2bW9jm-1}}}%
\nwixlogsorted{c}{{Proof: $\forall\varphi\in\Aut(G)\forall z\in G, z\in Z(G)\implies \varphi(z)\in Z(G)$}{NW47t2dy-1r6XYV-1}{\nwixu{NW47t2dy-1dPqXM-1}\nwixd{NW47t2dy-1r6XYV-1}}}%
...
\nwixlogsorted{c}{{Step 1: $g\in\varphi[\varphi^{-1}(H)]\implies g\in H$}{NW47t2dy-47FJLD-1}{\nwixu{NW47t2dy-1ZaFZM-1}\nwixd{NW47t2dy-47FJLD-1}}}%
\nwixlogsorted{c}{{Step 2: $g\in\varphi[\varphi^{-1}(H)]\impliedby g\in H$}{NW47t2dy-WRyHP-1}{\nwixu{NW47t2dy-1ZaFZM-1}\nwixd{NW47t2dy-WRyHP-1}}}%
...
\nwixlogsorted{c}{{Sub-step 1: $a\in\varphi^{-1}(H)$}{NW47t2dy-3vZPH1-1}{\nwixu{NW47t2dy-WRyHP-1}\nwixd{NW47t2dy-3vZPH1-1}}}%
\nwixlogsorted{c}{{Sub-step 2: $b\in\varphi[\varphi^{-1}(H)]$}{NW47t2dy-2IWBBW-1}{\nwixu{NW47t2dy-WRyHP-1}\nwixd{NW47t2dy-2IWBBW-1}}}%
\nwixlogsorted{c}{{Sub-step 3: $g\in\varphi[\varphi^{-1}(H)]$}{NW47t2dy-kMqjk-1}{\nwixu{NW47t2dy-WRyHP-1}\nwixd{NW47t2dy-kMqjk-1}}}%
