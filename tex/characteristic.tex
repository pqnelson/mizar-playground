...
proof
  ...
  proof
    ...
    proof
      ...
      assume H0: z in H;
      then phi.z = (phi|H).z by \nwlinkedidentc{Lm3}{NW18nMBU-3Uc8Un-1};
      H1: Image(phi|H) is Subgroup of H by A1;
      z is Element of H by H0,STRUCT_0:def 5;
      then (phi|H).z in Image(phi|H) by H0,GROUP_6:45;
      hence (phi|H).z in H by H1, GROUP_2:40;
    end;
    A3: for phi being \nwlinkedidentc{Automorphism}{NW1Nnu7l-4WeeL5-1} of G
    holds Image(phi|H) is Subgroup of H
    proof
      let phi be \nwlinkedidentc{Automorphism}{NW1Nnu7l-4WeeL5-1} of G;
      H1: rng(phi|H) c= the carrier of G &
      the carrier of H c= the carrier of G by GROUP_2:def 5;
      for z being Element of G st z in H holds (phi|H).z in H by A2;
      for w being Element of G st w in rng(phi|H) holds w in H
      proof
        let w be Element of G;
        assume H2: w in rng(phi|H);
        then consider z being object such that
        H3: z in dom(phi|H) and
        H4: (phi|H).z = w by FUNCT_1:def 3;
        H5: dom(phi|H) = the carrier of H by FUNCT_2:def 1;
        reconsider z as Element of H by H3;
        H6: z in H by STRUCT_0:def 5;
        z is Element of G by GROUP_2:42;
        then (phi|H).z in H by A2,H6;
        hence w in H by H4;
      end;
      then for w being Element of G holds w in rng(phi|H) implies w in H;
      then for w being Element of G holds w in rng(phi|H) implies w in the carrier of H by STRUCT_0:def 5;
      then H2: rng(phi|H) c= the carrier of H by H1,SUBSET_1:2;
      then the carrier of Image(phi|H) c= the carrier of H by GROUP_6:44;
      hence H3: Image(phi|H) is Subgroup of H by GROUP_2:57;
    end;
    A4: for phi being \nwlinkedidentc{Automorphism}{NW1Nnu7l-4WeeL5-1} of G
    ...
    proof
      ...
      consider psi being \nwlinkedidentc{Automorphism}{NW1Nnu7l-4WeeL5-1} of G such that
      AA1: psi = phi" and
      B1: Image(phi|Image(psi|H)) is Subgroup of Image(phi|H) by A3,\nwlinkedidentc{Lm39}{NW47t2dy-2FnGSI-1};
      consider psi2 being \nwlinkedidentc{Automorphism}{NW1Nnu7l-4WeeL5-1} of G such that
      AA2: psi2 = phi" and
      B2: the multMagma of H = the multMagma of Image(phi|Image(psi2|H)) by A3,\nwlinkedidentc{Lm40}{NW47t2dy-1FL4YM-1};
      psi2 = psi by AA1,AA2;
      hence H is Subgroup of Image(phi|H) by B1,B2;
    end;
    for phi being \nwlinkedidentc{Automorphism}{NW1Nnu7l-4WeeL5-1} of G
    holds H = Image(phi|H)
    proof
      let phi be \nwlinkedidentc{Automorphism}{NW1Nnu7l-4WeeL5-1} of G;
      AA1: H is strict Subgroup of G & Image(phi|H) is strict Subgroup of G;
...
proof
  ...
  proof
    ...
    proof
      ...
      then (phi|Image(psi|H)).a = phi.a by \nwlinkedidentc{Lm3}{NW18nMBU-3Uc8Un-1};
...
\nwused{\\{NW47t2dy-4Z20G4-1}}\nwidentdefs{\\{{\nwixident{Lm40}}{Lm40}}}\nwidentuses{\\{{\nwixident{Automorphism}}{Automorphism}}\\{{\nwixident{Lm11}}{Lm11}}\\{{\nwixident{Lm3}}{Lm3}}}\nwindexuse{\nwixident{Automorphism}}{Automorphism}{NW47t2dy-1FL4YM-1}\nwindexuse{\nwixident{Lm11}}{Lm11}{NW47t2dy-1FL4YM-1}\nwindexuse{\nwixident{Lm3}}{Lm3}{NW47t2dy-1FL4YM-1}\nwendcode{}\nwbegindocs{44}\nwdocspar
...
A3: for phi being \nwlinkedidentc{Automorphism}{NW1Nnu7l-4WeeL5-1} of G
  ...
  hence Z is \nwlinkedidentc{characteristic}{NW47t2dy-49dosn-1} Subgroup of G by Th27;
end;

\nwindexdefn{\nwixident{Th28}}{Th28}{NW47t2dy-g56Nl-1}\eatline
\nwused{\\{NW47t2dy-3N17ED-1}}\nwidentdefs{\\{{\nwixident{Th28}}{Th28}}}\nwidentuses{\\{{\nwixident{Automorphism}}{Automorphism}}\\{{\nwixident{characteristic}}{characteristic}}\\{{\nwixident{Lm11}}{Lm11}}\\{{\nwixident{Lm3}}{Lm3}}}\nwindexuse{\nwixident{Automorphism}}{Automorphism}{NW47t2dy-g56Nl-1}\nwindexuse{\nwixident{characteristic}}{characteristic}{NW47t2dy-g56Nl-1}\nwindexuse{\nwixident{Lm11}}{Lm11}{NW47t2dy-g56Nl-1}\nwindexuse{\nwixident{Lm3}}{Lm3}{NW47t2dy-g56Nl-1}\nwendcode{}
