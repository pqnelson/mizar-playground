...
\M We can look up the definitions for {\Tt{}rng\ f\nwendquote} and {\Tt{}f\ .:\ X\nwendquote}, which
...
\M Proving the forward direction amounts to unfolding definitions.
...
\M Proving the backward direction amounts to unfolding the same
...
\nwused{\\{NW18nMBU-oqDk7-1}}\nwidentdefs{\\{{\nwixident{Lm10}}{Lm10}}}\nwendcode{}\nwbegindocs{32}\nwdocspar
\M Proving $h(x) = f(x)$ amounts to unfolding definitions.
...
\M Unfolding the definition of inverse functions gives us the result.
...
\M Almost identical unfolding of definitions as the other case.
...
\LA{}Theorem: $(\forall\varphi\in\Aut(G),\varphi(H)\subgroup H)\implies \varphi[\varphi^{-1}(H)]=H$~{\nwtagstyle{}\subpageref{NW1Nnu7l-46CXaO-1}}\RA{}
...
\begin{theorem}
  Let $G$ be a group, and $H\subgroup G$ be a subgroup such that it is
  invariant under the Automorphisms of $G$, i.e.,
  $\forall\varphi\in\Aut(G)$ we have $\varphi(H)\subgroup H$.
...
\nwenddocs{}\nwbegincode{23}\sublabel{NW1Nnu7l-46CXaO-1}\nwmargintag{{\nwtagstyle{}\subpageref{NW1Nnu7l-46CXaO-1}}}\moddef{Theorem: $(\forall\varphi\in\Aut(G),\varphi(H)\subgroup H)\implies \varphi[\varphi^{-1}(H)]=H$~{\nwtagstyle{}\subpageref{NW1Nnu7l-46CXaO-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NW1Nnu7l-32pmQO-1}}\nwenddeflinemarkup
theorem \nwlinkedidentc{Th7}{NW1Nnu7l-46CXaO-1}:
  for H being Subgroup of G
  st (for f being \nwlinkedidentc{Automorphism}{NW1Nnu7l-4WeeL5-1} of G holds Image(f|H) is Subgroup of H)
  for phi being \nwlinkedidentc{Automorphism}{NW1Nnu7l-4WeeL5-1} of G
  holds ex psi being \nwlinkedidentc{Automorphism}{NW1Nnu7l-4WeeL5-1} of G
...
\nwused{\\{NW1Nnu7l-46CXaO-1}}\nwendcode{}\nwbegindocs{26}\nwdocspar

\M We begin by showing, if $g\in\varphi[\varphi^{-1}(H)]$, then there is
...
\M Showing $a\in\varphi^{-1}(H)$ and $g=\varphi(a)$ follow from basic results.
...
\M Almost the same reasoning applies to $b\in H$ satisfying
$a=\varphi^{-1}(b)$.
...
\nwixlogsorted{c}{{Theorem: $(\forall\varphi\in\Aut(G),\varphi(H)\subgroup H)\implies \varphi[\varphi^{-1}(H)]=H$}{NW1Nnu7l-46CXaO-1}{\nwixu{NW1Nnu7l-32pmQO-1}\nwixd{NW1Nnu7l-46CXaO-1}}}%
...
proof
  let G be strict Group;
  let f be object;
  A1: f is \nwlinkedidentc{Automorphism}{NW1Nnu7l-4WeeL5-1} of G implies f is Element of Funcs (the carrier of G, the carrier of G) by FUNCT_2:9;
...
\M This is a slick argument, which is confusing until one realizes
...
\M This substep is ugly, and I offer no apology for it. There's probably
