...
\begin{definition}[{\mml[Th10]{group5}}]\mizindex{Center@\texttt{center}|see{$\mathtt{GROUP\_5:def 10}$}}\index{$Z(G)$}\index{Center}\index{Group!Center}
...
The class formula\index{Class Formula} for groups is proven in~\mml{arneson2003witt}.
