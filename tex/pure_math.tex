...
\begin{definition}\index{$Z(G)$}\index{Center}\index{Group!Center}
...
\verb#GROUP_5:def 10#.\MizDef{GROUP\_5}{10}
\end{remark}
...
\begin{remark}
Mizar proves this in theorem \verb#GROUP_6:Th41#.\MizThm{GROUP\_6}{41}
\end{remark}
...
\begin{remark}
Mizar proves this in theorem \verb#GROUP_6:Th56#.\MizThm{GROUP\_6}{56}
\end{remark}
...
\begin{definition}\index{Commutator}
...
\begin{remark}
Mizar defins its commutators, $[x,y]$ in \verb#GROUP_5:def 2#\MizDef{GROUP\_5}[002]{2}, and
